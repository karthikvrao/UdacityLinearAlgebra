...
class LinearSystem(object):
    ...
    def multiply_coefficient_and_row(self, coefficient, row):
        ...
        # Create new plane to avoid manually setting basepoints again after multiplication
    ...
    def compute_triangular_form(self):
        ...
        # Variable number in an equation starting at 0
        j = 0

        # Loop on one equation at a time
    ...
    def scale_row_to_make_coefficient_equal_one(self, row, col):
        # Multiply equation by leading variable's coefficient's reciprocal
        n = self[row].normal_vector
        beta = Decimal(1.0) / n[col]
        self.multiply_coefficient_and_row(beta, row)

    def clear_coefficients_above(self, row, col):
        # Reverse loop the equations and clear coefficients from last variable to first
    ...
    def raise_exception_if_contradictory_equation(self):
        # Raise exception for k = 0 equation
    ...
    def extract_direction_vectors_for_parameterization(self):
        ...
        # Set of free vars to work on to get direction vectors
        ...
        for free_var in free_variables_indices:
            ...
            # Vector coordinate for free var set as 1 as last equation
            # will always be of form z = z for free var
            vector_coords[free_var] = 1
            for i, p in enumerate(self.planes):
                pivot_var = pivot_indices[i]
                if pivot_var < 0:
                    break
                # Negating the coefficient of free var as its sign changes
                # on moving to RHS
...
class Parameterization(object):
    BASRPT_AND_DIR_VECTORS_MUST_BE_IN_SAME_DIM_MSG = (
    ...
    def __init__(self, basepoint, direction_vectors):
        ...
        try:
            ...
            raise Exception(self.BASRPT_AND_DIR_VECTORS_MUST_BE_IN_SAME_DIM_MSG)
