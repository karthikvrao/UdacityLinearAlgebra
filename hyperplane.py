...
class Hyperplane(object):
    ...
    def __eq__(self, other):
        ...
        # Base points of each hyperplane
        x0 = self.basepoint
        y0 = other.basepoint

        # Get vector connecting two hyperplane's basepoints
        basepoint_difference = x0.minus(y0)

        n = self.normal_vector
        # Check if the connecting vector is orthogonal to either hyperplane's normal vector
